...
const Icons = {
  ...
  pipeline: (
    <svg viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
      <path d="M2 4a1 1 0 011-1h2a1 1 0 011 1v12a1 1 0 01-1 1H3a1 1 0 01-1-1V4zm5 0a1 1 0 011-1h2a1 1 0 011 1v12a1 1 0 01-1 1H8a1 1 0 01-1-1V4zm5 0a1 1 0 011-1h2a1 1 0 011 1v12a1 1 0 01-1 1h-2a1 1 0 01-1-1V4z" />
    </svg>
  ),
  messages: (
    <svg viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
...
const navItems: NavItem[] = [
  ...
  { label: 'Lead Board', href: '/admin/leads', icon: Icons.leads },
  { label: 'Pipeline', href: '/admin/pipeline', icon: Icons.pipeline },
  { label: 'Messages', href: '/admin/messages', icon: Icons.messages },
  { label: 'Site Chat', href: '/admin/site-chat', icon: Icons.siteChat },
  { label: 'Sites', href: '/admin/sites', icon: Icons.sites },
